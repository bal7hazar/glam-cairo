...
///
/// Mirrors `glam::camera::lh::view::look_at_mat4`.
/// #### Panics
...
///   normalized.
/// * Bit-identical to `Mat4::look_at_lh` (`glam::mat4`), inlined: measured 4.2k (`look_to`) to 5.1k
...
/// Transforms left-handed world space points into left-handed Y-up view space.
///
/// Mirrors `glam::camera::lh::view::look_to_mat4`.
/// #### Panics
...
///   must be normalized.
/// * Bit-identical to `Mat4::look_to_lh` (`glam::mat4`), inlined: measured 4.2k (`look_to`) to 5.1k
///   (`look_at`) gas cheaper than calling it (`alt_look_*_mat4_delegate` in `gas/camera.snap`). `s`
///   is normalized (one square root, one shared division), every other element is exact or one
///   floored `dot3`.
#[inline(always)]
...
///
/// Mirrors `glam::camera::lh::view::look_at_affine3`.
/// #### Panics
/// * As [`look_at_mat4`].
/// #### Deviations
/// * The `glam_assert!` preconditions are not checked. The shared right-handed Mat4 look-to
...
///
/// Mirrors `glam::camera::lh::view::look_to_affine3`.
/// #### Panics
/// * As [`look_to_mat4`].
/// #### Deviations
/// * The `glam_assert!` preconditions are not checked. The shared right-handed Mat4 look-to
///   kernel is used with `dir` negated, then its affine columns are extracted.
#[inline(always)]
...
/// Transforms left-handed world space points into left-handed Y-up view space.
///
/// Mirrors `glam::camera::lh::view::look_at_mat3`.
/// #### Panics
/// * `'Vec3: normalize zero'` if `center == eye`, or if the direction and `up` are parallel.
/// * `'Fixed: overflow'` if an element does not fit the scalar range.
/// * `'i64_neg Underflow'` if an element is `MIN`.
...
/// Transforms left-handed world space points into left-handed Y-up view space.
///
/// Mirrors `glam::camera::lh::view::look_to_mat3`.
/// #### Panics
/// * `'Vec3: normalize zero'` if `dir` and `up` are parallel.
/// * `'Fixed: overflow'` if an element does not fit the scalar range.
/// * `'i64_neg Underflow'` if an element is `MIN`.
...
///
/// Mirrors `glam::camera::lh::view::look_at_quat`.
/// #### Panics
...
///   kernel is used with the normalized direction negated, then converted with
///   `Quat::from_mat3`.
#[inline(always)]
...
///
/// Mirrors `glam::camera::lh::view::look_to_quat`.
/// #### Panics
/// * As [`look_to_mat3`], then as [`QuatTrait::from_mat3`].
/// #### Deviations
/// * The `glam_assert!` preconditions are not checked. The shared right-handed Mat3 look-to
///   kernel is used with `dir` negated, then converted with `Quat::from_mat3`.
#[inline(always)]
