...
/// Alternative to `Vec3::div_scalar`. One correctly rounded `Fixed / Fixed` per component, as
/// glam-rs spells it.
#[inline(always)]
...
/// Alternative to `Vec3::from_homogeneous`. Three correctly rounded `Fixed / Fixed` instead of one
/// shared `Recip`.
#[inline(always)]
