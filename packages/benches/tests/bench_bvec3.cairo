//! Gas benchmarks of `glam::bvec3` and of the alternatives kept in `benches::alt::bvec3`
//! (the `alt_*` benches).
//!
...
use benches::alt::bvec3 as alt;
use benches::harness::{bb, sink};
use glam::bvec3::BVec3Trait;

#[test]
fn bitmask__base() {
    let _v = bb(BVec3Trait::new(true, false, true));
    let d = bb(5_u32);
    sink(d);
}
...
#[test]
fn bitmask__op() {
    let v = bb(BVec3Trait::new(true, false, true));
    let _d = bb(5_u32);
    sink(v.bitmask());
}
...
#[test]
fn any_first__base() {
    let _v = bb(BVec3Trait::new(true, false, false));
    let d = bb(true);
    sink(d);
}
...
#[test]
fn any_first__op() {
    let v = bb(BVec3Trait::new(true, false, false));
    let _d = bb(true);
    sink(v.any());
}
...
#[test]
fn any_last__base() {
    let _v = bb(BVec3Trait::new(false, false, true));
    let d = bb(true);
    sink(d);
}
...
#[test]
fn any_last__op() {
    let v = bb(BVec3Trait::new(false, false, true));
    let _d = bb(true);
    sink(v.any());
}
...
#[test]
fn all_first__base() {
    let _v = bb(BVec3Trait::new(false, true, true));
    let d = bb(true);
    sink(d);
}
...
#[test]
fn all_first__op() {
    let v = bb(BVec3Trait::new(false, true, true));
    let _d = bb(true);
    sink(v.all());
}
...
#[test]
fn all_last__base() {
    let _v = bb(BVec3Trait::new(true, true, false));
    let d = bb(true);
    sink(d);
}
...
#[test]
fn all_last__op() {
    let v = bb(BVec3Trait::new(true, true, false));
    let _d = bb(true);
    sink(v.all());
}
...
#[test]
fn set_first__op() {
    let mut v = bb(BVec3Trait::new(true, false, true));
    let i = bb(0_usize);
    let value = bb(false);
    v.set(i, value);
    sink(v);
...
#[test]
fn bitand__base() {
    let a = bb(BVec3Trait::new(true, false, true));
    let _b = bb(BVec3Trait::new(true, true, false));
    sink(a);
}
...
fn bitand__op() {
    let a = bb(BVec3Trait::new(true, false, true));
    let b = bb(BVec3Trait::new(true, true, false));
    sink(a & b);
}
...
fn splat__base() {
    let _s = bb(true);
    let d = bb(BVec3Trait::new(true, false, true));
    sink(d);
}
...
fn splat__op() {
    let s = bb(true);
    let _d = bb(BVec3Trait::new(true, false, true));
    sink(BVec3Trait::splat(s));
}

#[test]
fn from_array__base() {
    let _arr = bb([true, false, true]);
    let d = bb(BVec3Trait::new(true, false, true));
    sink(d);
}
...
#[test]
fn from_array__op() {
    let arr = bb([true, false, true]);
    let _d = bb(BVec3Trait::new(true, false, true));
    sink(BVec3Trait::from_array(arr));
}

#[test]
fn into_bool_array__base() {
    let _v = bb(BVec3Trait::new(true, false, true));
    let d = bb([true, false, true]);
    sink(d);
}
