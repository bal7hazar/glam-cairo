//! Gas benchmarks of `glam::bvec4` and of the alternatives kept in `benches::alt::bvec4`
//! (the `alt_*` benches).
//!
...
use benches::alt::bvec4 as alt;
use benches::harness::{bb, sink};
use glam::bvec4::BVec4Trait;

#[test]
fn bitmask__base() {
    let _v = bb(BVec4Trait::new(true, false, true, true));
    let d = bb(5_u32);
    sink(d);
}
...
#[test]
fn bitmask__op() {
    let v = bb(BVec4Trait::new(true, false, true, true));
    let _d = bb(5_u32);
    sink(v.bitmask());
}
...
#[test]
fn any_first__base() {
    let _v = bb(BVec4Trait::new(true, false, false, false));
    let d = bb(true);
    sink(d);
}
...
#[test]
fn any_first__op() {
    let v = bb(BVec4Trait::new(true, false, false, false));
    let _d = bb(true);
    sink(v.any());
}
...
#[test]
fn any_last__base() {
    let _v = bb(BVec4Trait::new(false, false, false, true));
    let d = bb(true);
    sink(d);
}
...
#[test]
fn any_last__op() {
    let v = bb(BVec4Trait::new(false, false, false, true));
    let _d = bb(true);
    sink(v.any());
}
...
#[test]
fn alt_any_hybrid_first__op() {
    let v = bb(BVec4Trait::new(true, false, false, false));
    let _d = bb(true);
    sink(alt::any_hybrid(v));
}

#[test]
fn alt_any_hybrid_last__base() {
    let _v = bb(BVec4Trait::new(false, false, false, true));
    let d = bb(true);
    sink(d);
}
...
#[test]
fn all_first__base() {
    let _v = bb(BVec4Trait::new(false, true, true, true));
    let d = bb(true);
    sink(d);
}
...
#[test]
fn all_first__op() {
    let v = bb(BVec4Trait::new(false, true, true, true));
    let _d = bb(true);
    sink(v.all());
}
...
#[test]
fn all_last__base() {
    let _v = bb(BVec4Trait::new(true, true, true, false));
    let d = bb(true);
    sink(d);
}
...
#[test]
fn all_last__op() {
    let v = bb(BVec4Trait::new(true, true, true, false));
    let _d = bb(true);
    sink(v.all());
}
...
#[test]
fn set_first__base() {
    let v = bb(BVec4Trait::new(true, false, true, false));
    let _i = bb(0_usize);
    let _value = bb(false);
    sink(v);
}
...
#[test]
fn set_first__op() {
    let mut v = bb(BVec4Trait::new(true, false, true, false));
    let i = bb(0_usize);
    let value = bb(false);
    v.set(i, value);
    sink(v);
...
#[test]
fn bitand__base() {
    let a = bb(BVec4Trait::new(true, false, true, false));
    let _b = bb(BVec4Trait::new(true, true, false, false));
    sink(a);
}
...
fn bitand__op() {
    let a = bb(BVec4Trait::new(true, false, true, false));
    let b = bb(BVec4Trait::new(true, true, false, false));
    sink(a & b);
}
...
fn splat__base() {
    let _s = bb(true);
    let d = bb(BVec4Trait::new(true, false, true, false));
    sink(d);
}
...
fn splat__op() {
    let s = bb(true);
    let _d = bb(BVec4Trait::new(true, false, true, false));
    sink(BVec4Trait::splat(s));
}

#[test]
fn from_array__base() {
    let _arr = bb([true, false, true, false]);
    let d = bb(BVec4Trait::new(true, false, true, false));
    sink(d);
}
...
#[test]
fn from_array__op() {
    let arr = bb([true, false, true, false]);
    let _d = bb(BVec4Trait::new(true, false, true, false));
    sink(BVec4Trait::from_array(arr));
}

#[test]
fn into_bool_array__base() {
    let _v = bb(BVec4Trait::new(true, false, true, false));
    let d = bb([true, false, true, false]);
    sink(d);
}
...
fn into_bool_array__op() {
    let v = bb(BVec4Trait::new(true, false, true, false));
    let _d = bb([true, false, true, false]);
    let r: [bool; 4] = v.into();
    sink(r);
}
...
fn into_u32_array__base() {
    let _v = bb(BVec4Trait::new(true, false, true, false));
    let d = bb([7_u32, 7_u32, 7_u32, 7_u32]);
    sink(d);
}
...
fn into_u32_array__op() {
    let v = bb(BVec4Trait::new(true, false, true, false));
    let _d = bb([7_u32, 7_u32, 7_u32, 7_u32]);
    let r: [u32; 4] = v.into();
    sink(r);
}
