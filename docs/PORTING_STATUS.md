...
| D2 | test runtime: one test crate per file / group (`Test glam` 22 min in CI), `scripts/affected.py` selective runs on pull requests, full run on `main`; brief `docs/briefs/D2-test-runtime.md`; after S3 | todo | |
