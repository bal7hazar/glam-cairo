...
| F8 | `fixed-cairo`: `asinh`, `acosh`, `atanh` (simba has them; not requested yet: only if nalgebra-cairo asks through the programme session) | todo | |
